...
[Zero to Mastery Learn PyTorch for Deep Learning course](https://dbourke.link/ZTMPyTorch), İnternetteki en iyi ikinci PyTorch öğrenme kursuna hoş geldiniz.(birinci kurs için :) [PyTorch documentation](https://pytorch.org/docs/stable/index.html)).
...
* [Kurs Materyalleri/İçeriği](https://github.com/mrdbourke/pytorch-deep-learning#course-materialsoutline)
* [Kurs Hakkında](https://github.com/mrdbourke/pytorch-deep-learning#about-this-course)
* [Durum](https://github.com/mrdbourke/pytorch-deep-learning#status) (Kurs İlerleme durumu)
